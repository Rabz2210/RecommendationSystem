...
public class DefaultCriteriaSetTest {
    ...
    public void testExecute(){
        ...
        DefaultCriteriaSet criteriaSet = new DefaultCriteriaSet();
        result = criteriaSet.execute(restaurantList,cuisineSorter,costBracketIdentifier);
