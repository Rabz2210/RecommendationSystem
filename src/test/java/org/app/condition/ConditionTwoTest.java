...
public class ConditionTwoTest {
    ...
    public void prepareData(){
        Restaurant[] ls = {
                ...
                new Restaurant("A7", Cuisine.Chinese,5,4,Boolean.TRUE,new Date(2023,02,22,12,00)),
    ...
    public void testConditionTwo(){
        ...
        ConditionTwo conditionTwo = new ConditionTwo(4);
        conditionTwo.executeCondition(restaurantList,result,cuisineSorter,costBracketIdentifier);
